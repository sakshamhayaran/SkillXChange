    ...
    return (
        <div>
            ...
            <div className='flex flex-col gap-10 p-5 md:p-10'>
                <input type="text" placeholder="Search by name, city, or skill..."
                    value={searchWord} onChange={(e) => setSearchWord(e.target.value.toLowerCase())}
                    className="border-2 p-2 rounded w-full md:w-1/2 mx-auto text-sm md:text-base" />
